...
function Login() {
  ...
  return (
    <main className="relative flex min-h-screen min-h-dvh w-full flex-col justify-start sm:justify-center items-center overflow-x-hidden bg-background px-5 pt-[max(64px,calc(env(safe-area-inset-top,0px)+28px))] pb-[max(2.5rem,calc(var(--safe-bottom)+1.75rem))]">
